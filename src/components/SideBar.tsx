const SideBar = () => {
  return (
    <>
      <div className="grid grid-cols-1 items-center sticky top-14 bg-black">
        <div className="flex flex-col my-2 items-center w-20 mx-2  cursor-pointer hover:bg-gray-700 p-1 rounded-md">
          <svg
        ...
        <div className="flex  flex-col items-center my-2 w-20 mx-2 cursor-pointer hover:bg-gray-700 p-1 rounded-md ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
